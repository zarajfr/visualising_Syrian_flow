...
fc = []
for fn in ["simres-f-cv-sp-00.csv", "simres-f-cv-sp-01.csv", "simres-f-cv-sp-02.csv", "simres-f-cv-sp-03.csv", "flee-exp-03.csv"]:
    sim = []
    with open(fn) as f2:
...
#     sns.lineplot(
#         data=df_all[a], x="month", y="flow-count", units="experiment-k",
#         estimator=None, color=".7", linewidth=1, ax=ax, legend = False
#     )

# g.savefig('validation-all.png')
